...
const EditPatientDetailForm = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			const response = await fetch(`http://localhost:3002/patients/${email}`, {
				method: 'POST',
				headers: {
			...
			console.log(response, 'resp in edit detail');
			if (response.ok) {
...
export default EditPatientDetailForm;
